...
class TestHomePage():
    ...
    def test_footer_items_present(self):
        ...
        Assert.true(self.footer.is_footer_area_visible, "Footer Region is missing  ")
        Assert.true(self.footer.is_footer_social_icons_visible, "Footer Social icons is missing ")
        Assert.true(self.footer.is_footer_navigation_links_visible, "Footer Navigation links are missing ")
        Assert.true(self.footer.is_footer_right_reserved_visible, "Footer All right reserved is missing")
    ...
    def test_footer_social_icon_click(self, url, element):
        ...
        icons = self.footer.get_social_icons
        icons[element].click()
    ...
    def test_footer_link_click(self, url, element):
        ...
        self.test_selenium.go_to_page(self.test_selenium.get_base_url())
        icons=self.footer.get_navigation_links
        icons[element].click()
