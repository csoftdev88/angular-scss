...
(function () {
  ...
  angular
    .module('mobius.controllers.reservations', [])
    .controller('ReservationsCtrl', Reservations);

  function Reservations($scope, $controller, $q, $state, $timeout, reservationService, scrollService, preloaderFactory,
                        propertyService, $window, _, breadcrumbsService, userObject, chainService,
                        metaInformationService, $location, Settings, $rootScope) {
