...
.constant('DynamicMessages', {
  'en':{
    ...
    'you_have_added_passbook': '<div>You have successfully added your reservation to wallet.</div>',
  ...
  'de':{
    ...
    'you_have_added_passbook': '<div>Sie haben Ihre Reservierung erfolgreich zu Wallet hinzugefügt.</div>',
