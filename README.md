...
3. Run `pm2 restart WEB` (If pm2 says there is no instance of WEB running do `NODE_ENV=production pm2 start server.js --name "WEB" -- --tenant=sandman --environment=live`)
